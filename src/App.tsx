      ...
      <div className="bg-slate-900 text-white py-2 text-xs font-medium">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5"><Truck className="w-3.5 h-3.5 text-amber-400" /> Same Day Delivery Available</span>
            <span className="hidden sm:flex items-center gap-1.5"><Star className="w-3.5 h-3.5 text-amber-400" /> Locally Owned Since 2005</span>
          </div>
          <div className="flex items-center gap-4">
            <a href="tel:251-968-6888" className="hover:text-amber-400 transition-colors">Gulf Shores: (251) 968-6888</a>
          </div>
        </div>
      </div>
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0 flex items-center gap-2">
            <div className="w-10 h-10 bg-slate-900 rounded-lg flex items-center justify-center">
              <span className="text-amber-400 font-bold text-xl">M</span>
            </div>
            <div className="flex flex-col">
              <span className="text-xl font-bold tracking-tight text-slate-900 leading-none">MATTRESS</span>
              <span className="text-sm font-medium text-slate-500 tracking-widest leading-none">DEPOT</span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <button className="bg-amber-500 hover:bg-amber-600 text-white px-5 py-2.5 rounded-full text-sm font-bold transition-all shadow-lg shadow-amber-500/20 flex items-center gap-2">
      ...
      {isMenuOpen && (
        ...
        >
          <div className="px-4 pt-2 pb-6 space-y-2">
            <a href="#mattresses" className="block px-3 py-3 text-base font-medium text-slate-700 hover:bg-slate-50 rounded-lg">Mattresses</a>
            <a href="#adjustable" className="block px-3 py-3 text-base font-medium text-slate-700 hover:bg-slate-50 rounded-lg">Adjustable Bases</a>
            <a href="#accessories" className="block px-3 py-3 text-base font-medium text-slate-700 hover:bg-slate-50 rounded-lg">Accessories</a>
            <a href="#about" className="block px-3 py-3 text-base font-medium text-slate-700 hover:bg-slate-50 rounded-lg">Why Us</a>
            <button className="w-full mt-4 bg-amber-500 text-white px-5 py-3 rounded-lg text-base font-bold">
              Visit Showroom
            </button>
          </div>
        </motion.div>
...
const StickyCallButton = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-200 md:hidden z-50 flex gap-3 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
      ...
      <a href="#contact" className="flex-1 bg-amber-500 text-white py-3 rounded-lg font-bold flex items-center justify-center gap-2 shadow-lg">
      ...
      >
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          <div>
            ...
            <select className="w-full rounded-lg border-slate-300 border p-2.5 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none">
              <option>Queen</option>
              <option>King</option>
              <option>Full</option>
              <option>Twin</option>
          ...
          <div>
            ...
            <input 
              ...
              className="w-full rounded-lg border-slate-300 border p-2.5 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none"
            />
          </div>

          <button className="w-full bg-amber-500 hover:bg-amber-600 text-white font-bold py-3 rounded-lg shadow-lg shadow-amber-500/20 transition-all mt-2">
            Check Stock Now
          </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, idx) => (
            <div key={idx} className="p-6 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow duration-300">
  ...
  return (
    <div className="bg-slate-900 text-white py-3 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-6 text-center">
        <span className="font-bold text-amber-400 uppercase tracking-wider text-sm">Special Offer</span>
        <span className="text-sm sm:text-base">
          Get <span className="font-bold">0% Interest Financing</span> for up to 60 Months*
        </span>
        <a href="#" className="text-xs sm:text-sm underline hover:text-amber-400 transition-colors">
          See if you qualify
        </a>
      </div>
    </div>
    ...
    <section className="py-20 bg-slate-50" id="mattresses">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredProducts.map((product) => (
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden bg-slate-100">
                <span className="absolute top-3 left-3 bg-amber-500 text-white text-xs font-bold px-3 py-1 rounded-full z-10 shadow-sm">
                  {product.tag}
                </span>
                <img 
                  src={product.image} 
        ...
        <div className="mt-12 text-center">
          <button className="inline-flex items-center gap-2 text-slate-900 font-bold border-b-2 border-slate-900 pb-1 hover:text-amber-600 hover:border-amber-600 transition-colors">
    ...
    <section className="py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div key={idx} className="border border-slate-200 rounded-xl overflow-hidden hover:border-amber-400/50 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
              ...
              <p>
                Unlike the big chains that make you wait weeks for delivery, <span className="font-bold text-amber-600">we stock what we sell.</span> That means you can walk in today and sleep better tonight.
              </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="#" className="text-amber-600 font-medium hover:underline mt-1 inline-block">Get Directions</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:251-968-6888" className="text-lg font-bold text-slate-900 hover:text-amber-600 transition-colors">(251) 968-6888</a>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-lg font-bold text-white">MATTRESS DEPOT</span>
            </div>
            ...
            <div className="flex gap-4">
              {/* Social placeholders */}
              <div className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center hover:bg-amber-500 transition-colors cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="#" className="hover:text-amber-400 transition-colors">Mattresses</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Adjustable Bases</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Pillows</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Protectors</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Clearance</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:251-968-6888" className="hover:text-amber-400">(251) 968-6888</a>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          ...
          <div className="flex gap-6 items-center">
            ...
            <button 
              ...
              className={`flex items-center gap-1 hover:text-amber-400 transition-colors ${showAdminLink ? 'opacity-100' : 'opacity-0'}`}
            >
